    ...
    <body id="user">
        ...
        <div class="container mt-5">
                <div class="alert alert-success mb-2" role="alert">
                    ...
                    <hr>
                    <p class="mb-0">¡Has incluido una puntuación de <?php echo $puntuacion?> estrellas! <a href="../inicio/inicio.php?pagina=1" class="alert-link"><strong>Pulse aquí para consultar los locales</strong></a></p>
                </div>
            </div>  
        <?php } else { ?>
                <div class="container mt-5">
